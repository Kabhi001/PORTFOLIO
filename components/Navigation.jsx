  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-4 pointer-events-none">
      <motion.nav
        ...
        className={`pointer-events-auto transition-all duration-300 rounded-full border border-white/10 ${
          isScrolled
      ...
      >
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <span className="text-[#ff6b6b]">Abhishek</span>
              <span className="inline-block w-2"></span>
              <span className="text-[#00d4ff]">Kumar</span>
            </motion.a>
